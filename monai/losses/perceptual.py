...
class PerceptualLoss(nn.Module):
    ...
    Args:
        ...
        network_type: specifies the network architecture to use. Defaults to ``"alex"``.
        Can be:``"alex"``, ``"vgg"``, ``"squeeze"``,
        ``"radimagenet_resnet50"``, ``"medicalnet_resnet10_23datasets"``, ``"medicalnet_resnet50_23datasets"``, ``"resnet50"``.
